...
from kitty.layout.constraints import FixedConstraintModel, FrameConstraintModel, FrameSpec, LinearConstraintModel, SplitConstraintModel
...
class TestLayout(BaseTest):
    ...
    def test_frame_constraint_model(self):
        ...
        frames, gap = FrameConstraintModel()(specs, ((0, 1), (0, 2)), ((1, 2),), 6, 8)
        ...
        self.ae(top_right.left - left.right, gap)
        self.ae(bottom_right.left - left.right, gap)
        self.ae(bottom_right.top - top_right.bottom, gap)
